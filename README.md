...
Phone: 8136842364 | Email: nehas170499@gmail.com   LinkedIn: 
nehas-ts | GitHub: 
NehasTS17 
Portfolio: 
Personal Portfolio | Location: Chennai  
CAREER OBJECTIVES
Aspiring Dot NET Full Stack Developer with hands-on experience in C#, ASP.NET MVC, Web API, Web
Forms, ReactJS and MySQL. Passionate about developing responsive web applications and solving real
world problems using modern technologies, delivering scalable high-quality solutions efficiently.
EDUCATION
Master of Computer Application (MCA) – 87%  | 2022
Arul Anandar College, Madurai Kamaraj University  
Bachelor of Science (Computer Science) – 76% | 2020
St. Jude’s College, Manonmaniam Sundaranar University
TECHNICAL SKILLS
Languages: C#, JavaScript, HTML5, CSS3  
Frontend: ReactJS, Tailwind CSS  
Backend: ASP.NET MVC, ASP.NET Web API, ASP.NET Web Forms
Concepts: REST API, CRUD Operations, LINQ  
Database: MySQL, SQL  
Tools: Git, GitHub, VS Code, Postman, Visual Studio 2026 
...
PROJECT
MobileMart – E-Commerce Website (Frontend)
Developed an e-commerce frontend using ReactJS and Tailwind CSS with dynamic product filtering.  
Implemented responsive UI and improved user experience with optimized component design.
Personal Portfolio Website (Frontend)
Developed a responsive portfolio website using ReactJS, Tailwind CSS, and React Router DOM.  
Implemented dark mode, reusable components, and optimized UI for better user experience.
FitFusion Pro – Smart Fitness, Nutrition & Multi-Vendor Commerce
Developed FitFusion Pro, a full stack application using C#, ASP.NET MVC, Web API, ReactJS, and
MySQL. Implemented scalable architecture, responsive UI, and optimized backend services for
performance.
COURSES
Completed hands-on training in .NET Full Stack Development at SLA Institute, Chennai.  
Worked on real-time projects using C#, ASP.NET MVC, Web API, ReactJS, and MySQL.
CERTIFICATIONS
Dot NET Full Stack Development – SLA Institute, Chennai 
